...
class AppConfig {
  ...
  static const String appDashboardConfigurationPath =
  ...
  static const String iOSKeychainSharingGroupId =
      'KUT463DS29.com.linagora.ios.teammail.shared';
  static const String iOSKeychainSharingService =
      'com.linagora.ios.teammail.sessions';
  static const String saasPlatform = 'saas';
  static const String linagoraPrivacyUrl =
  ...
  static String get webOidcUrl => dotenv.get('WEB_OIDC_URL', fallback: '');
  ...
  static bool get isWebSocketEchoPingEnabled =>
      dotenv.get('WS_ECHO_PING', fallback: 'false') == 'true';

  static bool get isCozyIntegrationEnabled =>
      dotenv.get('COZY_INTEGRATION', fallback: 'false') == 'true';

  static String get cozyExternalBridgeVersion =>
      dotenv.get('COZY_EXTERNAL_BRIDGE_VERSION', fallback: '0.16.1');
}
